...
**关联文档**：
- [[06_数据库/08_MongoDB/MongoDB核心概念与架构]]（文档模型、WiredTiger、副本集）
- [[06_数据库/08_MongoDB/MongoDB索引与查询优化]]（索引配置、聚合管道优化）
- [[06_数据库/08_MongoDB/MongoDB事务与一致性]]（Spring @Transactional 底层原理）
- PostgreSQL vs MySQL 面试对比（建模思维差异、事务差异）
