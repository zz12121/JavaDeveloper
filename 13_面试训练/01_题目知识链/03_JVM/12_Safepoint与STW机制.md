...
- `[[13_面试训练/01_题目知识链/03_JVM/12_Safepoint与STW机制]]` → GC 停顿的本质
...
2. 打开 `[[13_面试训练/01_题目知识链/03_JVM/12_Safepoint与STW机制]]` 主题文档，画出「进入 Safepoint」的完整时序
3. 在 Obsidian 里建双向链接：`[[03_JVM/07_垃圾收集器/垃圾收集器]]` ←→ 本卡片（Mixed GC 需要初始标记，触发 Safepoint）
