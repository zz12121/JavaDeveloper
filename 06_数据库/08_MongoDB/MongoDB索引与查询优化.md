...
**关联文档**：
- [[06_数据库/08_MongoDB/MongoDB核心概念与架构]]（存储引擎、WiredTiger、副本集）
- [[06_数据库/02_索引/B+树索引原理]]（MongoDB B树 vs MySQL B+树对比）
- [[06_数据库/06_PostgreSQL/SQL优化与执行计划]]（MongoDB explain vs MySQL EXPLAIN 对比）
- [[06_数据库/08_MongoDB/MongoDB事务与一致性]]（索引对事务性能的影响）
